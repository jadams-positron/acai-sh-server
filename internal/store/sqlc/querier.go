...
type Querier interface {
	...
	ListEventsForImpl(ctx context.Context, arg ListEventsForImplParams) ([]ListEventsForImplRow, error)
	ListEventsForProduct(ctx context.Context, arg ListEventsForProductParams) ([]ListEventsForProductRow, error)
	ListEventsForTeam(ctx context.Context, arg ListEventsForTeamParams) ([]ListEventsForTeamRow, error)
	...
	ListMembersForTeam(ctx context.Context, teamID string) ([]ListMembersForTeamRow, error)
	ListProductsForTeam(ctx context.Context, teamID string) ([]Product, error)
